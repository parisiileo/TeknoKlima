 ...
 * route e la rivela dopo. Niente flash bianco.
 *
 * Intercetta i click sui link interni via event delegation; con
 * prefers-reduced-motion la navigazione resta nativa (nessun overlay).
 */
export function PageTransition({ children }: { children: React.ReactNode }) {
  ...
  /* Uscita: click su link interno → wipe in → push */
  useEffect(() => {
  ...
  /* Entrata: al cambio pathname → scroll top istantaneo + wipe out */
